-- CivicPulse AI / Smart Civic CMS v2.0 - Initial Database & Spatial Migration
...
CREATE TABLE IF NOT EXISTS complaints (
    ...
    -- Operational Assignment & SLA Oversight
...
-- 6. Linked Tickets / Child Submissions Table (Duplicate cluster records)
...
-- 10. Proximity Deduplication Engine (20-Meter Radius Check via PostGIS)
...
-- 12. Automated SLA Deadline Trigger
...
DO $$ BEGIN
    ...
    DROP POLICY IF EXISTS "Public Read Audit Logs" ON complaint_audit_logs;
    ...
    -- Supervisor Ward Administration
